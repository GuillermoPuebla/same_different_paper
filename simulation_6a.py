...
def test_all_models_all_conditions_auc(batch_size):
    ...
    for ds, condition in zip(datasets, conditions):
        data = test_model_auc(
            ds=ds,
            weights_dir='simulation_6/trained_in_original',
...
if __name__ == '__main__':
    ...
    fine_tune_model(
        train_ds=train_ds,
        save_name='simulation_6/trained_in_irregular/',
    ...
    # Test.
    df = test_all_models_all_conditions_auc(batch_size=112)
    df.to_csv('simulation_6/sim_6a_auc.csv')
