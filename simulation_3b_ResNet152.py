...
# Model builder
def make_ResNet152_sd_classifier_with_ds_label(
...
def fine_tune_model_with_ds_label(
    ...
    with strategy.scope():
        for i in range(n):
            # Define model
            base_model, model = make_ResNet152_sd_classifier_with_ds_label(
...
# Testing
def test_model_auc_with_ds_label(model, ds, weights_dir, gap, model_name, condition):
...
def test_models_all_ds_auc_with_ds_label(
    ...
    with strategy.scope():
        # Define model architecture.
        base_model, model = make_ResNet152_sd_classifier_with_ds_label(base_weights=None, base_trainable=True, gap=True)
...
if __name__ == '__main__':
    ...
    fine_tune_model_with_ds_label(
        ...
        train_ds=train_ds,
        val_ds=None,
        save_name='simulation_3/task_classification/ResNet152_instances',
        model_name='ResNet152',
    ...
    df = test_models_all_ds_auc_with_ds_label(
        ...
        autotune_settings=AUTO,
        batch_size=200,
        weights_dir='simulation_3/task_classification/ResNet152_instances', 
        ds_dir='data'
        )
    df.to_csv('simulation_3/task_classification/sim_3_ResNet152_taskclass_test_auc.csv')

    # Validate
    validate_models_all_ds_auc_with_ds_label(
        strategy=strategy,
        autotune_settings=AUTO,
        batch_size=560, 
        weights_dir='simulation_3/task_classification/ResNet152_instances', 
    ...
    df.to_csv('simulation_3/task_classification/sim_3_ResNet152_taskclass_val_auc.csv')
