...
if __name__ == '__main__':
    ...
    df.to_csv('simulation_5/sim_5_ResNet_test_auc.csv')
    # Validate
    ...
    df.to_csv('simulation_5/sim_5_ResNet_val_auc.csv')
    ...
    df = get_model_predictions_all_ds(
        ...
        batch_size=BATCH_SIZE,
        steps=TEST_STEPS,
        weights_path='simulation_5/ResNet_instances/ResNet50_instance_0.hdf5',
        run=0,
        ds_dir='data'
        )
    df.to_csv('simulation_5/sim_5_ResNet_density.csv')