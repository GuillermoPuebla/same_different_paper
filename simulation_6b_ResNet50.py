...
if __name__ == '__main__':
    ...
    fine_tune_model(
        strategy=strategy,
        train_ds=train_ds,
        save_name='simulation_6b/siamese_instances',
        model_name='siamese',
    ...
    df = test_all_models_all_conditions_auc(
        ...
        autotune_settings=AUTO,
        batch_size=1120, 
        weights_dir='simulation_6b/siamese_instances', 
        ds_dir='data'
        )
    df.to_csv('simulation_6b/sim_6b_siamese_test_auc.csv')
    # Validate
    ...
    df.to_csv('simulation_6b/sim_6b_siamese_val_auc.csv')
